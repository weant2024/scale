...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['contratos'])) {
    ...
    ?>
        ...
        <div class="form-group">
            <label>Selecione o(s) contrato(s): <a href='#' id='reset-button' onclick='limparCampos()'><img src='assets/img/lock.jpeg' width='30px'></a></label>
            <div class="d-flex">            
            ...
            if ($resultado_horarios->num_rows > 0) {
                ...
                if ($resultado_afastamento->num_rows > 0) {
                    while ($row = $resultado_afastamento->fetch_assoc()) {
                        ...
                        $horarios[$row['id_usuario']][$dataFormatted] = $motivo;
                    }
                }
            }
