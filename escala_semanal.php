...
<script>
    ...
    // Função para ajustar currentWeekStart para a segunda-feira mais próxima
    ...
    function showPreviousWeek() {
        ...
        adjustToMonday(currentWeekStart);
        generateWeek();
    }
    ...
    // Inicializar a semana atual ajustando para segunda-feira
    adjustToMonday(currentWeekStart);
    generateWeek();
</script>
