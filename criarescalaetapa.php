                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            <div class="form-group">                        
                                <div class="selecionar">    
                                    <div class="nav">
                                    <button type="submit" style="background-color: #2a2f5b; color: white; border: none; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin-top: 10px; cursor: pointer; border-radius: 4px;"
                                          onmouseover="this.style.backgroundColor='#8800ff';"
                                          onmouseout="this.style.backgroundColor='#2a2f5b';">Enviar</button>
