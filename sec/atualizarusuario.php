...
if ( $nivel < 2 ) 
{
	header("Location: ../login/sec/sec_tipo.php"); exit;
}
?>
...
?>
<?php
$query1 = "INSERT INTO registrousuario ( `id_usuario` , `login` , `senha` , `nome` , `rg` , `rgorgao` , `rguf` , `matricula` , `email` , `telefone` , `departamento` , `cargo` , `nivel` , `pnivel` , `ativo` , `pativo` , `gerasenha` , `horario` , `dia` , `semana` , `mes` , `ano` , `operador` ) VALUES ( '$id', '$login', '$criptografada', '$nome', '$rg', '$rgorgao', '$rguf', '$matricula', '$email', '$telefone', '$departamentousuario', '$cargousuario', '$nivelusuario', '$pnivel', '$ativousuario', '$pativo', '$gerasenha', '$horario', '$dia', '$semana', '$mes', '$ano', '$operador' )";
$result1 = $conn->query($query1);

$query2 = "UPDATE usuario SET login='$login', nome='$nome', rg='$rg', rgorgao='$rgorgao', rguf='$rguf', matricula='$matricula', email='$email', telefone='$telefone', departamento='$departamentousuario', cargo='$cargousuario', nivel='$nivelusuario', pnivel='$pnivel', ativo='$ativousuario', pativo='$pativo', gerasenha='$gerasenha' WHERE id='$id'"; 
$result2 = $conn->query($query2);

$msg = "Atualiza��o de dados do usu�rio realizado com sucesso!";
